...
Such lengthened vowels can only occur in the penultimate syllable of a word, and are denoted in some pages by the macron accent (though the acute is still used in normal Eldirin texts), so **firyomívan** is stressed **fìryomīvan**.
